            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-8 text-gray-500">Geen event boekingen</div>
                    ) : (
                        eventTitles.map(eventTitle => (
                            <div key={eventTitle} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                                <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
                                    ...
                                    <p className="text-xs text-gray-500">{groupedByEvent[eventTitle].length} reserveringen</p>
                                </div>
                                <div className="divide-y divide-gray-100">
                                    {groupedByEvent[eventTitle].map(booking => (
                                        <div
                                            key={booking.id}
